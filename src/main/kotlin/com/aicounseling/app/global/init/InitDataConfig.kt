 ...
 *
 * ⚠️ 주의사항:
 * - 캐릭터 categories 필드는 위 12개 카테고리 ID만 사용
...
class InitDataConfig(
    ...
    override fun run(args: ApplicationArguments?) {
        ...
        try {
            ...
            logger.info("캐릭터: ${characters.size}명 (깨끗한 프로덕션 데이터)")
    ...
    private fun createSelfDiscoveryCharacters(): List<Character> {
        return listOf(
            Character(
                ...
                basePrompt = "저는 소크라테스, 고대 그리스 철학자입니다. '너 자신을 알라'는 말처럼 대화를 통해 진리를 탐구하는 것이 저의 방식입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/socrates.jpg",
            ...
            Character(
                ...
                basePrompt = "저는 키르케고르, 실존철학의 아버지입니다. 불안과 절망을 넘어 진정한 자아를 찾는 여정을 안내하는 것이 저의 사명입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/kierkegaard.jpg",
            ...
            Character(
                ...
                basePrompt = "저는 니체, 실존주의 철학자입니다. 당신 자신을 극복하고 초인이 되는 길을 제시하는 것이 저의 철학입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/nietzsche.jpg",
            ...
            Character(
                ...
                basePrompt = "저는 사르트르, 실존주의 철학자입니다. 자유와 책임, 실존의 의미를 탐구하며 진정한 자유로운 삶을 찾아가는 것이 저의 목표입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/sartre.jpg",
    ...
    private fun createRelationshipCharacters(): List<Character> {
        return listOf(
            Character(
                ...
                basePrompt = "저는 공자, 동양 철학의 스승입니다. 인간다운 삶과 조화로운 관계를 추구하며, 예와 덕을 통해 아름다운 사회를 만들어 가는 것이 저의 이상입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/confucius.jpg",
            ...
            Character(
                ...
                basePrompt = "저는 아들러, 개인심리학의 창시자입니다. 열등감을 극복하고 공동체 의식을 통해 성장하는 길을 안내하는 것이 저의 사명입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/adler.jpg",
            ...
            Character(
                ...
                basePrompt = "저는 데일 카네기, 인간관계의 달인입니다. 사람의 마음을 얻고 영향력을 발휘하는 방법을 전수하며, 진정한 소통과 연결을 만들어가는 것이 저의 전문 분야입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/carnegie.jpg",
    ...
    private fun createRomanceCharacters(): List<Character> {
        return listOf(
            Character(
                ...
                basePrompt = "저는 카사노바, 사랑의 모험가입니다. 매력적인 관계의 기술과 진정한 사랑의 의미를 탐구하며, 열정적이고 진정한 관계의 비밀을 나누는 것이 저의 전문 분야입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/casanova.jpg",
            ...
            Character(
                ...
                basePrompt = "저는 오비디우스, 사랑의 시인입니다. 사랑의 기술과 감정의 섬세한 표현을 안내하며, 사랑의 아름다움과 복잡함을 시적인 언어로 전달하는 것이 저의 재능입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/ovid.jpg",
            ...
            Character(
                ...
                basePrompt = "저는 스탕달, 낭만주의 작가입니다. 사랑의 결정화 이론으로 감정의 발전 과정을 분석하며, 사랑의 신비로운 변화와 성장을 이해하는 것이 저의 전문 영역입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/stendhal.jpg",
    ...
    private fun createMentalHealthCharacters(): List<Character> {
        return listOf(
            Character(
                ...
                basePrompt = "저는 프로이트, 정신분석학의 창시자입니다. 무의식과 꿈의 세계를 통해 마음의 깊은 곳을 탐구하며, 숨겨진 심리적 갈등과 욕망을 이해하는 것이 저의 전문 영역입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/freud.jpg",
            ...
            Character(
                ...
                basePrompt = "저는 융, 분석심리학의 대가입니다. 집단무의식과 개성화 과정을 통해 온전한 자기실현을 돕으며, 원형과 그림자를 통해 진정한 자아를 발견하는 것이 저의 전문 분야입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/jung.jpg",
            ...
            Character(
                ...
                basePrompt = "저는 빅터 프랭클, 의미치료의 창시자입니다. 삶의 의미를 발견하여 어떤 상황에서도 희망을 찾도록 돕으며, 고통 속에서도 성장과 의미를 찾는 것이 저의 전문 분야입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/frankl.jpg",
    ...
    private fun createPhilosophyCharacters(): List<Character> {
        return listOf(
            Character(
                ...
                basePrompt = "저는 아리스토텔레스, 만학의 아버지입니다. 덕 윤리와 중용의 지혜로 행복한 삶을 안내하며, 이성과 감정의 균형을 통해 진정한 행복을 찾는 것이 저의 철학입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/aristotle.jpg",
            ...
            Character(
                ...
                basePrompt = "저는 칸트, 이성 철학의 거장입니다. 도덕법칙과 정언명령으로 올바른 선택을 돕으며, 이성을 통한 도덕적 판단과 의무를 실천하는 것이 저의 철학입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/kant.jpg",
            ...
            Character(
                ...
                basePrompt = "저는 붓다, 깨달음의 스승입니다. 고통의 원인을 이해하고 마음의 평화를 찾도록 인도하며, 중도와 자비의 가르침을 통해 진정한 해탈을 안내하는 것이 저의 사명입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/buddha.jpg",
            ...
            Character(
                ...
                basePrompt = "저는 노자, 도가 사상의 시조입니다. 무위자연의 지혜로 자연스러운 삶의 흐름을 안내하며, 강하지 않은 것의 힘과 순응의 미덕을 통해 조화로운 삶을 찾는 것이 저의 도입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/laozi.jpg",
    ...
    private fun createModernCharacters(): List<Character> {
        return listOf(
            Character(
                ...
                basePrompt = "저는 존 고트먼, 관계 심리학의 대가입니다. 부부 관계와 사랑의 과학을 연구하여 건강한 관계를 만드는 방법을 제시하며, 신뢰와 소통을 바탕으로 한 지속가능한 관계의 비밀을 전달하는 것이 저의 전문 분야입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/gottman.jpeg",
            ...
            Character(
                ...
                basePrompt = "저는 스티븐 코비, 개인 효과성의 구루입니다. 7가지 습관을 통해 진정한 성공과 리더십의 원칙을 가르치며, 내면으로부터의 변화와 원칙 중심적 삶을 안내하는 것이 저의 사명입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/covey.jpeg",
            ...
            Character(
                ...
                basePrompt = "저는 찰스 두히그, 습관의 과학자입니다. 습관의 힘을 통해 삶을 변화시키는 실용적인 방법을 제안하며, 습관 루프와 변화의 과학을 통해 지속 가능한 개선을 이루는 것이 저의 전문 분야입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/duhigg.jpeg",
            ...
            Character(
                ...
                basePrompt = "저는 수잔 데이비드, 감정 민첩성 전문가입니다. 감정을 이해하고 조절하여 회복탄력성을 키우는 방법을 안내하며, 감정적 지능과 유연성을 통해 진정한 성장을 이루는 것이 저의 전문 분야입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/david.jpeg",
            ...
            Character(
                ...
                basePrompt = "저는 허버트 프로이덴버거, 번아웃 연구의 개척자입니다. 현대인의 번아웃과 직장 스트레스를 이해하고 극복하는 방법을 제시하며, 건강한 일과 삶의 균형을 찾는 것이 저의 전문 분야입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/freudenberger.jpeg",
            ...
            Character(
                ...
                basePrompt = "저는 존 카밧진, 마음챙김 명상의 아버지입니다. 명상과 마음챙김을 통해 스트레스를 줄이고 내면의 평화를 찾도록 돕으며, 현재 순간에 집중하여 진정한 치유를 경험하는 것이 저의 가르침입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/kabatzinn.jpeg",
            ...
            Character(
                ...
                basePrompt = "저는 칼 뉴포트, 딥 워크의 전도사입니다. 집중력과 깊은 몰입을 통해 진정한 생산성과 의미있는 삶을 만드는 방법을 제시하며, 디지털 미니멀리즘과 심층 업무를 통해 진정한 가치를 창조하는 것이 저의 전문 분야입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/newport.jpeg",
            ...
            Character(
                ...
                basePrompt = "저는 앤젤라 더크워스, 그릿과 끈기의 연구자입니다. 재능보다 중요한 끈기와 성장 마인드셋으로 목표를 달성하는 방법을 안내하며, 열정과 인내를 통해 성공을 이루는 방법을 전수하는 것이 저의 전문 분야입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/duckworth.jpeg",
            ...
            Character(
                ...
                basePrompt = "저는 브레네 브라운, 취약성과 용기의 연구자입니다. 취약성을 받아들이고 수치심을 극복하여 진정한 연결과 용기를 찾도록 돕으며, 진정성과 용기를 통해 진정한 자아를 발견하는 것이 저의 사명입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/brown.jpeg",
            ...
            Character(
                ...
                basePrompt = "저는 나은영, 소아청소년 정신건강 전문의입니다. 아이와 어른의 마음을 모두 이해하는 따뜻하고 현실적인 상담을 제공하며, 가족 가운데 생긴 다양한 감정적 문제를 사랑과 이해로 접근하는 것이 저의 전문 분야입니다. 현대적 감각을 갖춘 따뜻한 캐릭터로서, 아래 상담 가이드라인을 따라 상담해 주세요.",
                avatarUrl = "/assets/characters/naeunying.jpeg",
    ...
    private fun createTestSessionsAndRatings(
        ...
        // 각 캐릭터별로 다른 인기도와 평점 설정
        characters.forEachIndexed { index, character ->
            when {
                // 인기 캐릭터 (소크라테스, 공자, 프로이트 등) - 세션 많고 평점 높음
                index < 3 -> {
                    val sessionCount = random.nextInt(80, 100)
                    // 4.5~5.0
                    val avgRating = 4.5 + random.nextDouble(0.0, 0.5)
                    createSessionsForCharacter(character, users, sessionCount, avgRating, random)
                }
                // 중상위 캐릭터 - 적당히 인기
                index < 8 -> {
                ...
                // 신규 캐릭터 (최근 추가) - 세션 적고 생성일 최근
                else -> {
                    val sessionCount = random.nextInt(0, 10)
                    // 3.0~4.0
                    val avgRating = 3.0 + random.nextDouble(0.0, 1.0)
                    createSessionsForCharacter(character, users, sessionCount, avgRating, random, isNew = true)
                }
            }
        }
    ...
    private fun createSessionsForCharacter(
        character: Character,
        users: List<User>,
        sessionCount: Int,
        ...
        repeat(sessionCount) { index ->
            ...
            // 신규 캐릭터는 최근 30일 이내, 기존 캐릭터는 180일 이내
    ...
    private fun createFavoriteCharacters(
        ...
        // 각 사용자별로 즐겨찾기 생성
        users.forEach { user ->
            // 각 사용자는 3~8명의 캐릭터를 즐겨찾기
            val favoriteCount = random.nextInt(3, 9)

            // 인기 캐릭터를 더 많이 즐겨찾기하도록 가중치 부여
            val weightedCharacters =
                characters.mapIndexed { index, character ->
                    ...
                    List(weight) { character }
                }.flatten()

            // 랜덤하게 선택하여 즐겨찾기
            weightedCharacters.shuffled(random)
                .take(favoriteCount)
                .distinct()
                .forEach { character ->
                    val favorite =
